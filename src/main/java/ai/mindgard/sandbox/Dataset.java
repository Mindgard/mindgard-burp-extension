...
public enum Dataset {
    ...
    ToxicityHateSpeech("ToxicityHateSpeech", "Toxicity - Hate Speech"),
    ...
    CybersecurityIntrusionTechniques("CybersecurityIntrusionTechniques", "Cybersecurity - Intrusion Techniques"),
