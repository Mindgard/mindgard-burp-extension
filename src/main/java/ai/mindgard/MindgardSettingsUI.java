...
public class MindgardSettingsUI extends JPanel implements MindgardSettings {
    ...
    private String mindgardUrl;
    private String mindgardAudience;
    private String mindgardClientID;
    ...
    public MindgardSettingsUI() {
        ...
        if (burpJsonFile.exists()) {
            ...
            try (Stream<String> lines = Files.lines(burpJsonFile.toPath())) {
                ...
                settings = JSON.fromJson(jsonContent, Settings.class);
        ...
        this.uriManager = new MindgardServerConfiguration(settings);
        ...
        mindgardUrl = uriManager.getMindgardUrl();
        mindgardAudience = uriManager.getMindgardAudience();
        mindgardClientID = uriManager.getMindgardClientID();
        ...
        gbc.gridy = 11;
        gbc.weightx = 0;
        JLabel mindgardUrlLabel = new JLabel("Mindgard URL:");
        inputPanel.add(mindgardUrlLabel, gbc);

        gbc.gridx = 1;
        gbc.weightx = 1.0;
        JTextField mindgardUrlField = new JTextField(mindgardUrl, 30);
        inputPanel.add(mindgardUrlField, gbc);
        setupField(mindgardUrlField, mindgardUrlLabel);

        gbc.gridx = 0;
        gbc.gridy = 12;
        gbc.weightx = 0;
        JLabel mindgardAudienceLabel = new JLabel("Mindgard Audience:");
        inputPanel.add(mindgardAudienceLabel, gbc);

        gbc.gridx = 1;
        gbc.weightx = 1.0;
        JTextField mindgardAudienceField = new JTextField(mindgardAudience, 30);
        inputPanel.add(mindgardAudienceField, gbc);
        setupField(mindgardAudienceField, mindgardAudienceLabel);

        gbc.gridx = 0;
        gbc.gridy = 13;
        gbc.weightx = 0;
        JLabel mindgardClientIDLabel = new JLabel("Mindgard Client ID:");
        inputPanel.add(mindgardClientIDLabel, gbc);

        gbc.gridx = 1;
        gbc.weightx = 1.0;
        JTextField mindgardClientIDField = new JTextField(mindgardClientID, 30);
        inputPanel.add(mindgardClientIDField, gbc);
        setupField(mindgardClientIDField, mindgardClientIDLabel);
        ...
        loginButton.addActionListener((actionEvent) -> {
            var auth = new MindgardAuthentication(this);
        ...
        saveButton.addActionListener((actionEvent) -> {
            ...
            mindgardAudience = mindgardAudienceField.getText();
            mindgardUrl = mindgardUrlField.getText();
            try {
            ...
            JOptionPane.showMessageDialog(
                    ...
                    "Mindgard settings updated successfully!" + "\n" +
                            "Tests run using this configuration can be found at " + uriManager.getMindgardUrl() + "/results?project_id=" + projectID,
                    "Mindgard Extension",
                    JOptionPane.INFORMATION_MESSAGE
            );
    ...
    @Override
    public String mindgardAudience() { return mindgardAudience; }

    @Override
    public String mindgardUrl() { return mindgardUrl; }
    
    @Override
    public String mindgardClientID() { return mindgardClientID; }
}
